        ...
        <div className="flex flex-col gap-4 py-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              onChange={(e) => { setForm({ ...form, cover_image_url: e.target.value }); setCoverPreviewError(false) }}
              placeholder="Paste a cloud storage link..."
            />
                ...
                <div key={item.id} className="group relative flex flex-col rounded-lg border border-[var(--border-light)] overflow-hidden">
                  <div className="relative aspect-square overflow-hidden bg-[var(--bg-subtle)]">
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500/80 text-white opacity-0 group-hover:opacity-100 transition-opacity"
                    >
                      <Trash2 size={10} />
                    </button>
                  </div>
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-6 sm:px-6 sm:py-8">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col gap-3">
          {albums.map((album) => (
            <div key={album.id} className="rounded-xl border border-[var(--border-light)] bg-[var(--bg-surface)] overflow-hidden">
              <div className="flex items-center gap-4 p-4">
                ...
                <div className="flex shrink-0 items-center gap-1">
                  <button
                    onClick={() => handleToggleShared(album)}

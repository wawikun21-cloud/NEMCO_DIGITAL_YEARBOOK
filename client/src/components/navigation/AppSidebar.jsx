...
const NAV_MAIN = [
  ...
  { key: "library", label: "My Memories", icon: BookOpen, href: "/library" },
      ...
      <Sidebar collapsible="icon" className="border-r border-[--sidebar-border]">
        <SidebarHeader className="h-14 flex flex-row items-center px-3 border-b border-[--sidebar-border]">
          <div className="flex w-full items-center gap-3 overflow-hidden">
            <img src="/NEMCO-Logo.png" alt="NEMCO Logo" className="h-8 w-8 shrink-0 rounded-md object-contain" />
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    ...
                    <div className="flex min-w-0 flex-1 flex-col group-data-[collapsible=icon]:hidden">
                      <span className="truncate text-sm font-semibold leading-tight">{user?.email ?? "Account"}</span>
                      <span className="truncate text-[11px] leading-tight text-[--sidebar-foreground]/60">{role}</span>
                    </div>
                    <ChevronsUpDown size={14} className="ml-auto shrink-0 text-[--sidebar-foreground]/50 group-data-[collapsible=icon]:hidden" />
                  </SidebarMenuButton>
                </DropdownMenuTrigger>

                <DropdownMenuContent side="top" align="start" sideOffset={8} className="w-60 p-1.5">
                  <DropdownMenuLabel className="p-0 font-normal">
                    <div className="flex items-center gap-3 rounded-md px-3 py-3">
                      ...
                      <div className="flex min-w-0 flex-col gap-0.5">
                        <span className="truncate text-sm font-semibold leading-tight text-foreground">{user?.email ?? "Account"}</span>
